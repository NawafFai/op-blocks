...
المياه والتحلية والليثيوم والطاقة الخضراء — مبنية لبرنامج Aspen Plus V14.**
...
> 📷 *لقطات من داخل Aspen ستُضاف عند الإطلاق: لوحة CAPE-OPEN وفيها الـ 25 بلوكًا،
> وحالة OP-RO لمياه البحر بعد التقارب.*
...
3. **افتح Aspen Plus V14** ← لوحة النماذج ← تبويب **CAPE-OPEN** — الـ 25 بلوكًا
   كلها هناك. اسحبها، وصّلها، وشغّل.

المتطلبات: Windows 10/11 x64، وAspen Plus V14، و.NET Framework 4.8 (مدمج في
ويندوز). محوّل DWSIM موجود في الكود المصدري لكنه **تجريبي وغير مختبَر في v1.0** —
المضيف المدعوم هو Aspen Plus.
...
ملاحظة: يتضمّن `OPBlocks.sln` محوّل DWSIM التجريبي الذي يحتاج تثبيت DWSIM
لترجمته — ابنِ مشروع الاختبارات كما في الأعلى للمكتبة الموجّهة لـ Aspen.

## كيف يعمل التحقّق ("مصنع البلوكات")

كل بلوك يُبنى مقابل البوابات نفسها (السجل الهندسي الكامل في
...
يقدّم الإصدار v1.0 خمسةً وعشرين بلوكًا مخصّصًا لـ Aspen Plus V14. تهدف المرحلة
الثانية إلى تحويل OP-Blocks من مكتبة بلوكات إلى **منصّة**. هذا اتجاه، لا ميزات
منجَزة — لا شيء مما يلي مكتمل بعد.
