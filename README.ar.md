...
المتطلبات: Windows 10/11 x64، و.NET Framework 4.8 (مدمج في ويندوز)، و**Aspen
Plus V14** أو **DWSIM**. كلاهما مضيف CAPE-OPEN مدعوم: يحدّد البلوك ثيرمو المضيف
تلقائيًا (Thermo 1.1 في Aspen، وThermo 1.0 في DWSIM)، فيعمل البلوك نفسه على
الاثنين.
