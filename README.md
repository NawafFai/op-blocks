...
![version](https://img.shields.io/badge/version-1.1.0-29ABE2)
...
1. **Download** the latest release (`OPBlocks_Setup.exe`, or
   `OPBlocks-1.1.0-portable.zip` and extract anywhere).
...
v1.0 delivers 25 custom CAPE-OPEN blocks for Aspen Plus and DWSIM. Phase 2
