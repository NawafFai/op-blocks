...
This release adds **one-click DWSIM enablement** (native blocks with icons),
**bulk install/remove**, and a **professionally redesigned Manager** on top of
the complete, physics-validated block library from v1.0.0.

> ### 👉 Which file do I download?
> **Most people: download `OPBlocks_Setup.exe`, run it, done.**
> Prefer no installer? Download `OPBlocks-1.1.0-portable.zip` instead and run
...
**Portable:** download `OPBlocks-1.1.0-portable.zip`, right-click > Properties >
...
- `OPBlocks-1.1.0-portable.zip` — portable distribution with `INSTALL.bat`
